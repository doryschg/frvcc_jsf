package bo.gob.sin.sre.fac.frvcc;
...
public class Starter {
  ...
  //      applications.put("frvcc.recepcion", RecepcionBackendAplication.class);
    ...
    private static HashMap<String, HashMap<String, Class<?>>> commands() {
      ...
      //        commands.put("recepcion", RecepcionBackendAplication.commands());
