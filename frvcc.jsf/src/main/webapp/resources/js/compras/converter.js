...
DataConverter.prototype.convert = function() {
  ...
  if (this.inputText.length > 0) {
    ...
    if(!this.headersProvided)  
    {
        ...
        camposCabecera.val3 = "Número Autorización / CUF";
        camposCabecera.val4 = "Fecha Emisión";
        camposCabecera.val5 = "Importe Total Compra";
        camposCabecera.val6 = "Código de Control";
