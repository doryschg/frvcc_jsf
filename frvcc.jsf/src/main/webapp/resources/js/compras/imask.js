...
(function (global, factory) {
  ...
  */
    ...
    function maskedClass(mask) {
        ...
        if (_instanceof(mask, RegExp)) return IMask.MaskedRegExp; // $FlowFixMe

        if (isString(mask)) return IMask.MaskedPattern; // $FlowFixMe

        if (_instanceof(mask, Date) || mask === Date) return IMask.MaskedDate; // $FlowFixMe

        if (_instanceof(mask, Number) || typeof mask === 'number' || mask === Number) return IMask.MaskedNumber; // $FlowFixMe

        if (Array.isArray(mask) || mask === Array) return IMask.MaskedDynamic; // $FlowFixMe

        if (IMask.Masked && _instanceof(mask.prototype, IMask.Masked)) return mask; // $FlowFixMe

        if (_instanceof(mask, Function)) return IMask.MaskedFunction; // $FlowFixMe

        if (_instanceof(mask, IMask.Masked)) return mask.constructor;
    ...
    function createMask(opts) {
        // $FlowFixMe
        if (IMask.Masked && _instanceof(opts, IMask.Masked)) return opts;
        opts = Object.assign({}, opts);
        var mask = opts.mask; // $FlowFixMe

        if (IMask.Masked && _instanceof(mask, IMask.Masked)) return mask;
    ...
    var ChunksTailDetails = /*#__PURE__*/function () {
        ...
        _createClass(ChunksTailDetails, [{
            ...
            value: function extend(tailChunk) {
                ...
                if (_instanceof(tailChunk, ContinuousTailDetails)) {
                ...
                } else if (_instanceof(tailChunk, ChunksTailDetails)) {
            ...
            value: function appendTo(masked) {
                // $FlowFixMe
                if (!_instanceof(masked, IMask.MaskedPattern)) {
                ...
                for (var ci = 0; ci < this.chunks.length && !details.skip; ++ci) {
                    ...
                    if (stop != null && ( // if block not found or stop is behind lastBlock
                        ...
                        if (_instanceof(chunk, ChunksTailDetails) || // for continuous block also check if stop is exist
                            masked._stops.indexOf(stop) >= 0) {
                            details.aggregate(masked._appendPlaceholder(stop));
                        }

                        chunkBlock = _instanceof(chunk, ChunksTailDetails) && masked._blocks[stop];
                    }
        ...
        _createClass(MaskedPattern, [{
            ...
            value: function extractTail() {
                ...
                this._forEachBlocksInRange(fromPos, toPos, function (b, bi, bFromPos, bToPos) {
                    ...
                    if (_instanceof(blockChunk, ChunksTailDetails)) blockChunk.blockIndex = bi;
    ...
    var InputMask = /*#__PURE__*/function () {
        ...
        function InputMask(el, opts) {
            ...
            this.el = _instanceof(el, MaskElement) ? el : el.isContentEditable && el.tagName !== 'INPUT' && el.tagName !== 'TEXTAREA' ? new HTMLContenteditableMaskElement(el) : new HTMLMaskElement(el);
        ...
        _createClass(InputMask, [{
            ...
            value: function maskEquals(mask) {
                return mask == null || mask === this.masked.mask || mask === Date && _instanceof(this.masked, MaskedDate);
            }
        }, {
            key: "_bindEvents",
            ...
            set: function set(mask) {
                ...
                if (!_instanceof(mask, IMask.Masked) && this.masked.constructor === maskedClass(mask)) {
